...
namespace loot {
    ...
    Container27 getAquaticAltarChestLoot(const Generator &g, const StructureComponent &altarChestPiece,
                                  gen::Stronghold *strongholdGenerator, bool accurate) {
        RNG lootSeed = stronghold_corridor_aquatic.getStrongholdLootSeed<checkCaves, checkWaterCaves>(
