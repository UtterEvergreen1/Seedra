...
#include "enchants/classes/__include.hpp"
...
bool Enchantment::Type::All::canEnchantItem(const lce::Item *itemIn) const {
...
bool      Enchantment::Type::Armor::canEnchantItem(const lce::Item *itemIn) const { return itemIn->getItemType() == lce::items::ItemType::ItemArmor; }
bool  Enchantment::Type::ArmorFeet::canEnchantItem(const lce::Item *itemIn) const { return itemIn->getArmorType() == lce::items::EntityEquipSlot::FEET; }
bool  Enchantment::Type::ArmorLegs::canEnchantItem(const lce::Item *itemIn) const { return itemIn->getArmorType() == lce::items::EntityEquipSlot::LEGS; }
bool Enchantment::Type::ArmorChest::canEnchantItem(const lce::Item *itemIn) const { return itemIn->getArmorType() == lce::items::EntityEquipSlot::CHEST; }
bool  Enchantment::Type::ArmorHead::canEnchantItem(const lce::Item *itemIn) const { return itemIn->getArmorType() == lce::items::EntityEquipSlot::HEAD; }
bool     Enchantment::Type::Weapon::canEnchantItem(const lce::Item *itemIn) const { return itemIn->getItemType() == lce::items::ItemType::ItemSword; }
bool     Enchantment::Type::Digger::canEnchantItem(const lce::Item *itemIn) const { return itemIn->getItemType() == lce::items::ItemType::ItemTool; }
bool Enchantment::Type::FishingRod::canEnchantItem(const lce::Item *itemIn) const { return itemIn->getItemType() == lce::items::ItemType::ItemFishingRod; }
bool  Enchantment::Type::Breakable::canEnchantItem(const lce::Item *itemIn) const { return itemIn->isDamageable(); }
bool        Enchantment::Type::Bow::canEnchantItem(const lce::Item *itemIn) const { return itemIn->getItemType() == lce::items::ItemType::ItemBow; }
bool    Enchantment::Type::Trident::canEnchantItem(const lce::Item *itemIn) const { return itemIn->getItemType() == lce::items::ItemType::ItemTrident; }


bool Enchantment::Type::Wearable::canEnchantItem(const lce::Item *itemIn) const {
...
bool Enchantment::canApply(const lce::Item *item) const {
