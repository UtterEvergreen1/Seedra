...
public:
    ...
    public:
        ...
        public:
            ...
            virtual bool canEnchantItem(const lce::Item* itemIn) const;
        };
        class All final : public Base {
        public:
            bool canEnchantItem(const lce::Item* itemIn) const override;
        };
    ...
    ND virtual bool canApply(const lce::Item* item) const;
