                                    ...
                                    if (WaterCaveGenerator::canReplaceBlock(chunkPrimer->getBlockId(x, y, z))) {
                                        if (y < 10) {
                                            if (rng.nextFloat() >= 0.25) {
                                                chunkPrimer->setBlockId(x, y, z, lce::blocks::OBSIDIAN_ID);
                                            } else {
                                                chunkPrimer->setBlockId(x, y, z, lce::blocks::MAGMA_BLOCK_ID);
                                            }
                                        } else {
                                            bool placedWater = false;
                                            if (x < 15) {
                                                if (chunkPrimer->getBlockId(x + 1, y, z) == lce::blocks::AIR_ID) {
                                                    placedWater = true;
                                                    chunkPrimer->setBlockId(x + 1, y, z, lce::blocks::FLOWING_WATER_ID);
                                                }
                                            }
                                            ...
                                            if (z < 15) {
                                                if (chunkPrimer->getBlockId(x, y, z + 1) == lce::blocks::AIR_ID) {
                                                    placedWater = true;
                                                    chunkPrimer->setBlockId(x, y, z + 1, lce::blocks::FLOWING_WATER_ID);
                                                }
                                            }
                                            ...
                                            if (!placedWater) {
                                                chunkPrimer->setBlockId(x, y, z, lce::blocks::STILL_WATER_ID);
                                            }
                                        }
                                    }
                                }
