...
struct BlockFv {
    ...
    undefined4 defaultBlockState(int param_1) {
...
public:
    ...
    UnderwaterLargeCaveGenerator(CONSOLE console, LCEVERSION version, int64_t seed, WORLDSIZE size, BIOMESCALE scale)
        : MapGenBase(console, version, seed, size, scale) {}


    /**
     * \brief
     * \param param_1 this might be self, rng object is located 8 bytes after this loc
     * \param param_2
     * \param param_3
     * \param param_4
     * \param param_5
    ...
    void addFeature(int param_1, Level* param_2, int param_3, int param_4, undefined4 param_5, undefined4 param_6,
        ...
        memcpy(auVar19, vectorMultiplyHighAndAddSignedHalfWordSaturate(in_vs50, in_vs50, in_vs50), 16);
        ...
        iVar1 = rng.nextInt(iVar1 + 1);
        iVar1 = rng.nextInt(iVar1 + 1);
        iVar2 = rng.nextInt(0xf);
        if (iVar2 != 0) { iVar1 = 0; }
        if (0 < iVar1) {
            PI_CONSTANT = 3.141592741012573;


            uint64_t intValue = 0x3ff0000000000000;
            uVar15 = *(double*) &intValue;

            dVar18 = 0.5;
            dVar16 = 0.125;
            do {
                iVar2 = rng.nextInt(0x10);
                dVar11 = (double) CONCAT44(0x43300000, param_4 * 0x10 + iVar2 ^ 0x80000000) - 4503601774854144.0;
                iVar2 = rng.nextInt(0x78);
                uVar3 = rng.nextInt(iVar2 + 8);
                ...
                if (iVar2 == 0) {
                    uVar20 = rng.nextLong();
                    addRoom(dVar8, dVar10, dVar11, param_1, param_2, (int) ((ulonglong) uVar20 >> 0x20), (int) uVar20,
                ...
                if (0 < (int) uVar3) {
                    ...
                    for (uVar4 = uVar3 >> 2; uVar4 != 0; uVar4 = uVar4 - 1) {
                        dVar5 = (double) rng.nextFloat();
                        dVar7 = (double) ((float) (dVar5 * PI_CONSTANT) + (float) (dVar5 * PI_CONSTANT));
                        dVar5 = (double) rng.nextFloat();
                        ...
                        uVar21 = rng.nextLong();
                        addTunnel(dVar8, dVar10, dVar11, dVar5, dVar7, dVar6, uVar15, param_1, param_2,
                                  (int) ((ulonglong) uVar21 >> 0x20), (int) uVar21, param_5, param_6, param_7, 0, 0);
                        dVar5 = (double) rng.nextFloat();
                        dVar6 = (double) ((float) (dVar5 * PI_CONSTANT) + (float) (dVar5 * PI_CONSTANT));
                        dVar5 = (double) rng.nextFloat();
                        ...
                        dVar5 = (double) (float) (dVar9 + dVar5);
                        uVar21 = rng.nextLong();
                        addTunnel(dVar8, dVar10, dVar11, dVar5, dVar6, dVar7, uVar15, param_1, param_2,
                                  (int) ((ulonglong) uVar21 >> 0x20), (int) uVar21, param_5, param_6, param_7, 0, 0);
                        dVar5 = (double) rng.nextFloat();
                        dVar6 = (double) ((float) (dVar5 * PI_CONSTANT) + (float) (dVar5 * PI_CONSTANT));
                        dVar5 = (double) rng.nextFloat();
                    ...
                    for (uVar3 = uVar3 & 3; uVar3 != 0; uVar3 = uVar3 - 1) {
                        ...
                        dVar5 = (double) (float) (dVar9 + dVar5);
                        uVar21 = rng.nextLong();
                        addTunnel(dVar8, dVar10, dVar11, dVar5, dVar7, dVar6, uVar20, param_1, param_2,
                                  (int) ((ulonglong) uVar21 >> 0x20), (int) uVar21, param_5, param_6, param_7, 0, 0);
                    }
                }
                iVar1 = iVar1 + -1;
    ...
    */
    ...
    void addTunnel(double param_1, double param_2, double param_3, double param_4, double param_5, double param_6,
        ...
        memcpy(auVar39, vectorMultiplyHighAndAddSignedHalfWordSaturate(in_vs50, in_vs50, in_vs50), 16);
        ...
        local_1f4 = param_9;
        local_1a8 = 0.0;
        fVar2 = (float) ((double) CONCAT44(0x43300000, param_12 * 0x10 + 8U ^ 0x80000000) - 4503601774854144.0);
        local_1ac = 0.0;
        fVar3 = (float) ((double) CONCAT44(0x43300000, param_13 * 0x10 + 8U ^ 0x80000000) - 4503601774854144.0);
        ...
        do {
            fVar41 = sinf(
                    ((float) ((double) CONCAT44(0x43300000, local_1f0 ^ 0x80000000) - 4503601774854144.0) * 3.141593) /
            ...
            LAB_02a60984:
                ...
                if ((fVar6 + 18.0) * (fVar6 + 18.0) <
                    -(fVar41 * fVar41 - (((float) param_1 - fVar2) * ((float) param_1 - fVar2) +
                                         ((float) param_3 - fVar3) * ((float) param_3 - fVar3))))
                    break;
                ...
                if (((((double) ((fVar2 - 16.0) - fVar41) <= param_1) &&
                    ...
                    if (iVar22 < 0) { iVar22 = 0; }
                    if (0x10 < iVar20) { iVar20 = 0x10; }
                    iVar10 = MathHelper::clamp((int) dVar25 + 1, 1, 0x78);    // clamp__3MthSFiN21
                    iVar11 = MathHelper::clamp((int) dVar24 + -1, 1, iVar10); // clamp__3MthSFiN21

                    /*
                     * _DAT_104c1c48 = Magma         | 213
                     * _DAT_104c19bc = Obsidian      |  49
                     * _DAT_104c1910 = Flowing Water |   8
                     * _DAT_104c1914 = Water         |   9
                     * _DAT_104c191c = Lava          |  11
                     *
                     *
                     * Magma material: _DAT_104c3510
                     * Obby  material: _DAT_104c3510
                     *
                     *
                     *
                     */
                    // int _DAT_104c1c48; // = 213;
                    // int _DAT_104c19bc; // =  49;
                    // int _DAT_104c1910; // =   8;
                    // int _DAT_104c1914; // =   9;
                    // int _DAT_104c191c; // =  11;
                    ...
                    if (iVar22 < iVar20) {
                        ...
                        dVar34 = -0.7;
                        do {
                            fVar41 = (float) ((double) ((float) ((double) (float) ((double) CONCAT44(
                                0x43300000, iVar22 + param_12 * 0x10 ^ 0x80000000) - 4503601774854144.0) +
                                                                 dVar38) - (float) param_1) / dVar32);
                            ...
                            if (local_208 < local_20c) {
                                do {
                                    fVar41 = (float) ((double) ((float) ((double) (float) ((double) CONCAT44(
                                        0x43300000, iVar20 + param_13 * 0x10 ^ 0x80000000) - 4503601774854144.0) +
                                        dVar38) - (float) param_3) / dVar32);
                                    ...
                                    if ((double) (float) (dVar28 + dVar27) < dVar24) {
                                        uVar23 = iVar10 - 1;
                                        iVar19_temp = (uVar23 - iVar11) + 1;
                                        if (iVar11 <= (int) uVar23) {
                                            uVar4 = iVar20 * 0x80;
                                            uVar5 = iVar22 * 0x800;
                                            do {
                                                dVar26 = (double) (float) ((double) ((float) ((double) (float) ((double) CONCAT44(
                                                    0x43300000, uVar23 ^ 0x80000000) - 4503601774854144.0) + dVar38) -
                                                    (float) param_2) / dVar33);

                                                uVar17 = uVar5 | uVar4 | uVar23;
                                                if (((dVar34 < dVar26) &&
                                                     ((double) (float) ((double) (float) (dVar28 +
                                                                                          (double) (float) (dVar26 *
                                                                                                            dVar26)) +
                                                                        dVar27) < dVar24)) &&
                                                    ((int) uVar23 < 0x3e)) {
    ...
    void addTunnel__26UnderwaterLargeCaveFeatureFP5LevelLiT3P11ChunkPrimerdN26fN29N23T6
        ...
        if (param_15 == 0xffffffff) {
            ...
            iVar9 = nextInt__6RandomFi(auStack_180, ((int)local_1f4 >> 1) +
        ...
        dVar38 = 0.5;
        do {
            fVar41 = sinf(((float)((double)CONCAT44(0x43300000,local_1f0 ^ 0x80000000) - 4503601774854144.0) * 3.141593) /
                          (float)((double)CONCAT44(0x43300000,local_1f4 ^ 0x80000000) - 4503601774854144.0));
            dVar32 = (double)(fVar41 * fVar6 + 1.5);
            dVar33 = (double)(float)(dVar32 * (double)(float)param_7);
            fVar41 = cosf((float)param_6);
                    ...
                    if (iVar22 < iVar20) {
                        ...
                        do {
                            fVar41 = (float)((double)((float)((double)(float)((double)CONCAT44(0x43300000,
                                iVar22 + param_12 * 0x10 ^ 0x80000000) - 4503601774854144.0) + dVar38) - (float)param_1) / dVar32);
                            dVar28 = (double)(fVar41 * fVar41);
                            iVar20 = local_208;
                            dVar36 = dVar24;
                            dVar35 = dVar25;
                            ...
                            if (local_208 < local_20c) {
                                do {
                                    fVar41 = (float)((double)((float)((double)(float)((double)CONCAT44(0x43300000,
                                        iVar20 + param_13  * 0x10 ^ 0x80000000) - 4503601774854144.0) + dVar38) - (float)param_3) / dVar32);
                                    dVar27 = (double)(fVar41 * fVar41);
                                    dVar29 = dVar24;
                                    dVar30 = dVar25;
                                    dVar31 = dVar34;
                                    if ((double)(float)(dVar28 + dVar27) < dVar24) {
                                        ...
                                        if (iVar11 <= (int)uVar23) {
                                            ...
                                            uVar5 = iVar22 * 0x800;
                                            do {
                                                dVar26 = (double)(float)((double)((float)((double)(float)((double)CONCAT44(0x43300000,uVar23 ^ 0x80000000) - 4503601774854144.0) + dVar38) - (float)param_2) / dVar33);
                                                uVar17 = uVar5 | uVar4 | uVar23;
                                                if (((dVar34 < dVar26) && ((double)(float)((double)(float)(dVar28 + (double)(float)(dVar26 * dVar26)) + dVar27) < dVar24)) &&
                                                    ((int)uVar23 < 0x3e)) {
