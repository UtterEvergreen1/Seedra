...
int Generator::genBiomes(int *cache, const Range &range) const {
    ...
    // TODO: Figure out why this loop is here
    // why is it duplicating the first half to the second half???
    // for (int i = 0; i < range.sx * range.sz; i++)
