...
enum BiomeID {
    ...
    // 10
    legacy_frozen_ocean,
    frozenOcean = legacy_frozen_ocean,
    frozen_river,
    ice_plains,
    ...
    desert_mutated = desert + 128,
    desert_lakes = desert_mutated,
    extreme_hills_mutated = extreme_hills + 128,
    gravelly_mountains = extreme_hills_mutated,
    flower_forest = forest + 128,
    taiga_mutated = taiga + 128,
    taiga_mountains = taiga_mutated,
    swampland_mutated = swampland + 128,
    swamp_hills = swampland_mutated,
    ice_plains_spikes = ice_plains + 128,
    ice_spikes = ice_plains_spikes,
    jungle_mutated = jungle + 128,
    modified_jungle = jungle_mutated,
    jungle_edge_mutated = jungle_edge + 128,
    modified_jungle_edge = jungle_edge_mutated,
    birch_forest_mutated = birch_forest + 128,
    tall_birch_forest = birch_forest_mutated,
    birch_forest_hills_mutated = birch_forest_hills + 128,
    tall_birch_hills = birch_forest_hills_mutated,
    roofed_forest_mutated = roofed_forest + 128,
    dark_forest_hills = roofed_forest_mutated,
    cold_taiga_mutated = cold_taiga + 128,
    snowy_taiga_mountains = cold_taiga_mutated,
    mega_spruce_taiga = mega_taiga + 128,
    giant_spruce_taiga = mega_spruce_taiga,
    redwood_taiga_hills_mutated = mega_taiga_hills + 128,
    giant_spruce_taiga_hills = redwood_taiga_hills_mutated,
    extreme_hills_plus_trees_mutated = extreme_hills_plus_trees + 128,
    modified_gravelly_mountains = extreme_hills_plus_trees_mutated,
    savanna_mutated = savanna + 128,
    shattered_savanna = savanna_mutated,
    savanna_plateau_mutated = savanna_plateau + 128,
    shattered_savanna_plateau = savanna_plateau_mutated,
    mesa_bryce = mesa + 128,
    eroded_badlands = mesa_bryce,
    mesa_plateau_stone_mutated = mesa_plateau_stone + 128,
    modified_wooded_badlands_plateau = mesa_plateau_stone_mutated,
    mesa_plateau_mutated = mesa_plateau + 128,
