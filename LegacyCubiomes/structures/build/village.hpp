...
namespace rolls {
    ...
    class VillagePiece : public StructureComponent {
    protected:
    ...
    public:
        ...
        explicit VillagePiece(int structureTypeIn) : structureType(structureTypeIn) {}
        ...
        MU static void func_189927_a(MU const World& p_189927_1_, gen::Village* villageIn, MU BoundingBox p_189927_2_, MU RNG& p_189927_3_, MU int p_189927_4_, MU int p_189927_5_, MU int p_189927_6_, MU FACING p_189927_7_) {
        ...
        MU static void func_189926_a(MU const World& p_189926_1_, gen::Village* villageIn, MU FACING p_189926_2_, MU int p_189926_3_, MU int p_189926_4_, MU int p_189926_5_, MU BoundingBox p_189926_6_) {
            if (!villageIn->isZombieInfested) {
    ...
    class MU Church final : public VillagePiece {
    public:
        Church() = delete;

        MU explicit Church(int structureType)
            : VillagePiece(structureType) {}

        bool addComponentParts(World& worldIn, RNG& rng, const BoundingBox& structureBB) override {
            int averageGroundLvl = getAverageGroundLevel(worldIn, structureBB);
            if (averageGroundLvl < 0) { return true; }
            offset(0, averageGroundLvl - maxY + 12 - 1, 0);
            ...
            fillWithBlocks(worldIn, structureBB, 1, 1, 1, 3, 3, 7, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 1, 5, 1, 3, 9, 3, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 0, 3, 0, 8, cobblestone, cobblestone, false);
            fillWithBlocks(worldIn, structureBB, 1, 1, 0, 3, 10, 0, cobblestone, cobblestone, false);
            fillWithBlocks(worldIn, structureBB, 0, 1, 1, 0, 10, 3, cobblestone, cobblestone, false);
            fillWithBlocks(worldIn, structureBB, 4, 1, 1, 4, 10, 3, cobblestone, cobblestone, false);
            fillWithBlocks(worldIn, structureBB, 0, 0, 4, 0, 4, 7, cobblestone, cobblestone, false);
            fillWithBlocks(worldIn, structureBB, 4, 0, 4, 4, 4, 7, cobblestone, cobblestone, false);
            fillWithBlocks(worldIn, structureBB, 1, 1, 8, 3, 4, 8, cobblestone, cobblestone, false);
            fillWithBlocks(worldIn, structureBB, 1, 5, 4, 3, 10, 4, cobblestone, cobblestone, false);
            fillWithBlocks(worldIn, structureBB, 1, 5, 5, 3, 5, 7, cobblestone, cobblestone, false);
            fillWithBlocks(worldIn, structureBB, 0, 9, 0, 4, 9, 4, cobblestone, cobblestone, false);
            fillWithBlocks(worldIn, structureBB, 0, 4, 0, 4, 4, 4, cobblestone, cobblestone, false);
            ...
            // this->func_189926_a(worldIn, villageIn, FACING::SOUTH, 2, 4, 7, structureBB);
            // this->func_189926_a(worldIn, villageIn, FACING::EAST, 1, 4, 6, structureBB);
            // this->func_189926_a(worldIn, villageIn, FACING::WEST, 3, 4, 6, structureBB);
            // this->func_189926_a(worldIn, villageIn, FACING::NORTH, 2, 4, 5, structureBB);
            ...
            // this->func_189927_a(worldIn, villageIn, structureBB, rng, 2, 1, 0, FACING::NORTH);
    ...
    class MU Field1 final : public VillagePiece {
    public:
        Field1() = delete;

        MU explicit Field1(int structureType)
            : VillagePiece(structureType) {}
        ...
        bool addComponentParts(World& worldIn, RNG& rng, const BoundingBox& structureBB) override {
            int averageGroundLvl = getAverageGroundLevel(worldIn, structureBB);
            if (averageGroundLvl < 0) { return true; }
            offset(0, averageGroundLvl - maxY + 4 - 1, 0);

            const lce::blocks::Block* iBlockState = getBiomeSpecificBlockState(&lce::blocks::BlocksInit::OAK_WOOD);
            fillWithBlocks(worldIn, structureBB, 0, 1, 0, 12, 4, 8, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 1, 2, 0, 7, &lce::blocks::BlocksInit::FARMLAND, &lce::blocks::BlocksInit::FARMLAND, false);
            fillWithBlocks(worldIn, structureBB, 4, 0, 1, 5, 0, 7, &lce::blocks::BlocksInit::FARMLAND, &lce::blocks::BlocksInit::FARMLAND, false);
            fillWithBlocks(worldIn, structureBB, 7, 0, 1, 8, 0, 7, &lce::blocks::BlocksInit::FARMLAND, &lce::blocks::BlocksInit::FARMLAND, false);
            fillWithBlocks(worldIn, structureBB, 10, 0, 1, 11, 0, 7, &lce::blocks::BlocksInit::FARMLAND, &lce::blocks::BlocksInit::FARMLAND, false);
            fillWithBlocks(worldIn, structureBB, 0, 0, 0, 0, 0, 8, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 6, 0, 0, 6, 0, 8, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 12, 0, 0, 12, 0, 8, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 0, 11, 0, 0, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 8, 11, 0, 8, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 3, 0, 1, 3, 0, 7, &lce::blocks::BlocksInit::FLOWING_WATER, &lce::blocks::BlocksInit::FLOWING_WATER, false);
            fillWithBlocks(worldIn, structureBB, 9, 0, 1, 9, 0, 7, &lce::blocks::BlocksInit::STILL_WATER, &lce::blocks::BlocksInit::FLOWING_WATER, false);

            const lce::blocks::Block* cropTypeA = getRandomCropType(additionalData >> 15 & 0xF);
            const lce::blocks::Block* cropTypeB = getRandomCropType(additionalData >> 10 & 0xF);
            const lce::blocks::Block* cropTypeC = getRandomCropType(additionalData >> 5 & 0xF);
            const lce::blocks::Block* cropTypeD = getRandomCropType(additionalData & 0xF);
            for (int i = 1; i <= 7; ++i) {
    ...
    class MU Field2 final : public VillagePiece {
    public:

        Field2() = delete;

        MU explicit Field2(int structureType)
            : VillagePiece(structureType) {}
        ...
        bool addComponentParts(World& worldIn, RNG& rng, const BoundingBox& structureBB) override {
            ...
            fillWithBlocks(worldIn, structureBB, 0, 1, 0, 6, 4, 8, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 1, 2, 0, 7, farmLand, farmLand, false);
            fillWithBlocks(worldIn, structureBB, 4, 0, 1, 5, 0, 7, farmLand, farmLand, false);
            fillWithBlocks(worldIn, structureBB, 0, 0, 0, 0, 0, 8, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 6, 0, 0, 6, 0, 8, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 0, 5, 0, 0, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 8, 5, 0, 8, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 3, 0, 1, 3, 0, 7, stillWater, stillWater, false);

            const lce::blocks::Block* cropTypeA = getRandomCropType(additionalData >> 5 & 0xF);
            const lce::blocks::Block* cropTypeB = getRandomCropType(additionalData & 0xF);
            for (int i = 1; i <= 7; ++i) {
                int j = getMaxAgeFromCrop(cropTypeA->getID());
                int k = j / 3;
                this->setBlockState(worldIn, cropTypeA->getStateFromMeta(rng.nextInt(k, j)), 1, 1, i, structureBB);
    ...
    class MU Hall final : public VillagePiece {
    public:

        Hall() = delete;

        MU explicit Hall(int structureType)
            : VillagePiece(structureType) {}

        bool addComponentParts(World& worldIn, RNG& rng, const BoundingBox& structureBB) override {
            int averageGroundLvl = getAverageGroundLevel(worldIn, structureBB);
            if (averageGroundLvl < 0) { return true; }
            offset(0, averageGroundLvl - maxY + 7 - 1, 0);
            ...
            fillWithBlocks(worldIn, structureBB, 1, 1, 1, 7, 4, 4, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 2, 1, 6, 8, 4, 10, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 2, 0, 6, 8, 0, 10, &lce::blocks::BlocksInit::DIRT, &lce::blocks::BlocksInit::DIRT, false);
            this->setBlockState(worldIn, iBlockState, 6, 0, 6, structureBB);
            fillWithBlocks(worldIn, structureBB, 2, 1, 6, 2, 1, 10, iBlockState6, iBlockState6, false);
            fillWithBlocks(worldIn, structureBB, 8, 1, 6, 8, 1, 10, iBlockState6, iBlockState6, false);
            fillWithBlocks(worldIn, structureBB, 3, 1, 10, 7, 1, 10, iBlockState6, iBlockState6, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 1, 7, 0, 4, iBlockState4, iBlockState4, false);
            fillWithBlocks(worldIn, structureBB, 0, 0, 0, 0, 3, 5, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 8, 0, 0, 8, 3, 5, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 0, 7, 1, 0, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 5, 7, 1, 5, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 1, 2, 0, 7, 3, 0, iBlockState4, iBlockState4, false);
            fillWithBlocks(worldIn, structureBB, 1, 2, 5, 7, 3, 5, iBlockState4, iBlockState4, false);
            fillWithBlocks(worldIn, structureBB, 0, 4, 1, 8, 4, 1, iBlockState4, iBlockState4, false);
            fillWithBlocks(worldIn, structureBB, 0, 4, 4, 8, 4, 4, iBlockState4, iBlockState4, false);
            fillWithBlocks(worldIn, structureBB, 0, 5, 2, 8, 5, 3, iBlockState4, iBlockState4, false);
            ...
            fillWithBlocks(worldIn, structureBB, 5, 0, 1, 7, 0, 3, &lce::blocks::BlocksInit::DOUBLE_STONE_SLAB, &lce::blocks::BlocksInit::DOUBLE_STONE_SLAB, false);
            ...
            this->setBlockState(worldIn, &lce::blocks::BlocksInit::AIR, 2, 1, 0, structureBB);
            this->setBlockState(worldIn, &lce::blocks::BlocksInit::AIR, 2, 2, 0, structureBB);
            // this->func_189926_a(worldIn, villageIn, FACING::NORTH, 2, 3, 1, structureBB);
            // this->func_189927_a(worldIn, villageIn, structureBB, rng, 2, 1, 0, FACING::NORTH);
            ...
            // this->func_189926_a(worldIn, villageIn, FACING::SOUTH, 6, 3, 4, structureBB);
            // this->func_189927_a(worldIn, villageIn, structureBB, rng, 6, 1, 5, FACING::SOUTH);
    ...
    class MU House1 final : public VillagePiece {
    public:

        House1() = delete;

        MU explicit House1(int structureType)
            : VillagePiece(structureType) {}

        bool addComponentParts(World& worldIn, RNG& rng, const BoundingBox& structureBB) override {
            int averageGroundLvl = getAverageGroundLevel(worldIn, structureBB);
            if (averageGroundLvl < 0) { return true; }
            offset(0, averageGroundLvl - maxY + 9 - 1, 0);
            ...
            const lce::blocks::Block* iBlockState6 = getBiomeSpecificBlockState(&lce::blocks::BlocksInit::OAK_FENCE);
            fillWithBlocks(worldIn, structureBB, 1, 1, 1, 7, 5, 4, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 0, 0, 0, 8, 0, 5, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 0, 5, 0, 8, 5, 5, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 0, 6, 1, 8, 6, 4, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 0, 7, 2, 8, 7, 3, iBlockState, iBlockState, false);
            ...
            fillWithBlocks(worldIn, structureBB, 0, 1, 0, 0, 1, 5, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 1, 1, 5, 8, 1, 5, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 8, 1, 0, 8, 1, 4, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 2, 1, 0, 7, 1, 0, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 0, 2, 0, 0, 4, 0, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 0, 2, 5, 0, 4, 5, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 8, 2, 5, 8, 4, 5, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 8, 2, 0, 8, 4, 0, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 0, 2, 1, 0, 4, 4, iBlockState4, iBlockState4, false);
            fillWithBlocks(worldIn, structureBB, 1, 2, 5, 7, 4, 5, iBlockState4, iBlockState4, false);
            fillWithBlocks(worldIn, structureBB, 8, 2, 1, 8, 4, 4, iBlockState4, iBlockState4, false);
            fillWithBlocks(worldIn, structureBB, 1, 2, 0, 7, 4, 0, iBlockState4, iBlockState4, false);
            const lce::blocks::Block* glassPane = &lce::blocks::BlocksInit::GLASS_PANE;
            ...
            this->setBlockState(worldIn, glassPane, 6, 2, 5, structureBB);
            fillWithBlocks(worldIn, structureBB, 1, 4, 1, 7, 4, 1, iBlockState4, iBlockState4, false);
            fillWithBlocks(worldIn, structureBB, 1, 4, 4, 7, 4, 4, iBlockState4, iBlockState4, false);
            fillWithBlocks(worldIn, structureBB, 1, 3, 4, 7, 3, 4, &lce::blocks::BlocksInit::BOOKSHELF, &lce::blocks::BlocksInit::BOOKSHELF, false);
            ...
            // this->func_189927_a(worldIn, villageIn, structureBB, rng, 1, 1, 0, FACING::NORTH);
    ...
    class MU House2 final : public VillagePiece {
    public:

        House2() = delete;

        MU explicit House2(int structureType)
            : VillagePiece(structureType) {}

        bool addComponentParts(World& worldIn, RNG& rng, const BoundingBox& structureBB) override {
            int averageGroundLvl = getAverageGroundLevel(worldIn, structureBB);
            if (averageGroundLvl < 0) { return true; }
            offset(0, averageGroundLvl - maxY + 6 - 1, 0);
            ...
            const lce::blocks::Block* iBlockState5 = getBiomeSpecificBlockState(&lce::blocks::BlocksInit::OAK_WOOD);
            const lce::blocks::Block* iBlockState6 = getBiomeSpecificBlockState(&lce::blocks::BlocksInit::OAK_FENCE);
            fillWithBlocks(worldIn, structureBB, 0, 1, 0, 9, 4, 6, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 0, 0, 0, 9, 0, 6, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 0, 4, 0, 9, 4, 6, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 0, 5, 0, 9, 5, 6, &lce::blocks::BlocksInit::STONE_SLAB, &lce::blocks::BlocksInit::STONE_SLAB, false);
            fillWithBlocks(worldIn, structureBB, 1, 5, 1, 8, 5, 5, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 1, 1, 0, 2, 3, 0, iBlockState3, iBlockState3, false);
            fillWithBlocks(worldIn, structureBB, 0, 1, 0, 0, 4, 0, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 3, 1, 0, 3, 4, 0, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 0, 1, 6, 0, 4, 6, iBlockState5, iBlockState5, false);
            this->setBlockState(worldIn, iBlockState3, 3, 3, 1, structureBB);
            fillWithBlocks(worldIn, structureBB, 3, 1, 2, 3, 3, 2, iBlockState3, iBlockState3, false);
            fillWithBlocks(worldIn, structureBB, 4, 1, 3, 5, 3, 3, iBlockState3, iBlockState3, false);
            fillWithBlocks(worldIn, structureBB, 0, 1, 1, 0, 3, 5, iBlockState3, iBlockState3, false);
            fillWithBlocks(worldIn, structureBB, 1, 1, 6, 5, 3, 6, iBlockState3, iBlockState3, false);
            fillWithBlocks(worldIn, structureBB, 5, 1, 0, 5, 3, 0, iBlockState6, iBlockState6, false);
            fillWithBlocks(worldIn, structureBB, 9, 1, 0, 9, 3, 0, iBlockState6, iBlockState6, false);
            fillWithBlocks(worldIn, structureBB, 6, 1, 4, 9, 4, 6, iBlockState, iBlockState, false);
            ...
            fillWithBlocks(worldIn, structureBB, 7, 2, 4, 8, 2, 5, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
    ...
    class MU House3 final : public VillagePiece {
    public:

        House3() = delete;

        MU explicit House3(int structureType)
            : VillagePiece(structureType) {}
        ...
        bool addComponentParts(World& worldIn, RNG& rng, const BoundingBox& structureBB) override {
            ...
            fillWithBlocks(worldIn, structureBB, 1, 1, 1, 7, 4, 4, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 2, 1, 6, 8, 4, 10, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 2, 0, 5, 8, 0, 10, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 1, 7, 0, 4, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 0, 0, 0, 0, 3, 5, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 8, 0, 0, 8, 3, 10, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 0, 7, 2, 0, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 5, 2, 1, 5, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 2, 0, 6, 2, 3, 10, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 3, 0, 10, 7, 3, 10, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 1, 2, 0, 7, 3, 0, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 1, 2, 5, 2, 3, 5, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 0, 4, 1, 8, 4, 1, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 0, 4, 4, 3, 4, 4, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 0, 5, 2, 8, 5, 3, iBlockState5, iBlockState5, false);
            ...
            fillWithBlocks(worldIn, structureBB, 3, 4, 5, 3, 4, 10, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 7, 4, 2, 7, 4, 10, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 4, 5, 4, 4, 5, 10, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 6, 5, 4, 6, 5, 10, iBlockState5, iBlockState5, false);
            fillWithBlocks(worldIn, structureBB, 5, 6, 3, 5, 6, 10, iBlockState5, iBlockState5, false);
            ...
            // this->func_189926_a(worldIn, villageIn, FACING::NORTH, 2, 3, 1, structureBB);
            // this->func_189927_a(worldIn, villageIn, structureBB, rng, 2, 1, 0, FACING::NORTH);
            fillWithBlocks(worldIn, structureBB, 1, 0, -1, 3, 2, -1, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
    ...
    class MU House4Garden final : public VillagePiece {
    public:
        House4Garden() = delete;

        MU explicit House4Garden(int structureType)
            : VillagePiece(structureType) {}
        ...
        bool addComponentParts(World& worldIn, RNG& rng, const BoundingBox& structureBB) override {
            ...
            fillWithBlocks(worldIn, structureBB, 0, 0, 0, 4, 0, 4, iBlockState, iBlockState, false);
            fillWithBlocks(worldIn, structureBB, 0, 4, 0, 4, 4, 4, iBlockState3, iBlockState3, false);
            fillWithBlocks(worldIn, structureBB, 1, 4, 1, 3, 4, 3, iBlockState1, iBlockState1, false);
            ...
            fillWithBlocks(worldIn, structureBB, 0, 1, 1, 0, 3, 3, iBlockState1, iBlockState1, false);
            fillWithBlocks(worldIn, structureBB, 4, 1, 1, 4, 3, 3, iBlockState1, iBlockState1, false);
            fillWithBlocks(worldIn, structureBB, 1, 1, 4, 3, 3, 4, iBlockState1, iBlockState1, false);
            const lce::blocks::Block* glassPane = &lce::blocks::BlocksInit::GLASS_PANE;
            this->setBlockState(worldIn, glassPane, 0, 2, 2, structureBB);
            ...
            fillWithBlocks(worldIn, structureBB, 1, 1, 1, 3, 3, 3, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);

            if (additionalData & 1) /* isRoofAccessible */ {
    ...
    class MU Path final : public VillagePiece {
    public:
        Path() = delete;
        
        MU explicit Path(int structureType)
            : VillagePiece(structureType) {}
    ...
    class MU Torch final : public VillagePiece {
    public:
        Torch() = delete;
        
        MU explicit Torch(int structureType)
            : VillagePiece(structureType) {}
        ...
        bool addComponentParts(World& worldIn, RNG& rng, const BoundingBox& structureBB) override {
            ...
            fillWithBlocks(worldIn, structureBB, 0, 0, 0, 2, 3, 1, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            ...
            // this->func_189926_a(worldIn, villageIn, FACING::EAST, 2, 3, 0, structureBB);
            // this->func_189926_a(worldIn, villageIn, FACING::NORTH, 1, 3, 1, structureBB);
            // this->func_189926_a(worldIn, villageIn, FACING::WEST, 0, 3, 0, structureBB);
            // this->func_189926_a(worldIn, villageIn, FACING::SOUTH, 1, 3, -1, structureBB);
            return true;
        }
    };
    ...
    class MU WoodHut final : public VillagePiece {
    public:
        WoodHut() = delete;

        MU explicit WoodHut(int structureType)
            : VillagePiece(structureType) {}
        ...
        bool addComponentParts(World& worldIn, RNG& rng, const BoundingBox& structureBB) override {
            ...
            const lce::blocks::Block* iblockstate3 = getBiomeSpecificBlockState(&lce::blocks::BlocksInit::OAK_WOOD);
            const lce::blocks::Block* iblockstate4 = getBiomeSpecificBlockState(&lce::blocks::BlocksInit::OAK_FENCE);
            fillWithBlocks(worldIn, structureBB, 1, 1, 1, 3, 5, 4, &lce::blocks::BlocksInit::AIR, &lce::blocks::BlocksInit::AIR, false);
            fillWithBlocks(worldIn, structureBB, 0, 0, 0, 3, 0, 4, iblockstate, iblockstate, false);
            fillWithBlocks(worldIn, structureBB, 1, 0, 1, 2, 0, 3, &lce::blocks::BlocksInit::DIRT, &lce::blocks::BlocksInit::DIRT, false);

            if (additionalData >> 8 & 1) { // isTallHouse
                fillWithBlocks(worldIn, structureBB, 1, 4, 1, 2, 4, 3, iblockstate3, iblockstate3, false);
            } else {
                fillWithBlocks(worldIn, structureBB, 1, 5, 1, 2, 5, 3, iblockstate3, iblockstate3, false);
            }
            ...
            fillWithBlocks(worldIn, structureBB, 0, 1, 0, 0, 3, 0, iblockstate3, iblockstate3, false);
            fillWithBlocks(worldIn, structureBB, 3, 1, 0, 3, 3, 0, iblockstate3, iblockstate3, false);
            fillWithBlocks(worldIn, structureBB, 0, 1, 4, 0, 3, 4, iblockstate3, iblockstate3, false);
            fillWithBlocks(worldIn, structureBB, 3, 1, 4, 3, 3, 4, iblockstate3, iblockstate3, false);
            fillWithBlocks(worldIn, structureBB, 0, 1, 1, 0, 3, 3, iblockstate1, iblockstate1, false);
            fillWithBlocks(worldIn, structureBB, 3, 1, 1, 3, 3, 3, iblockstate1, iblockstate1, false);
            fillWithBlocks(worldIn, structureBB, 1, 1, 0, 2, 3, 0, iblockstate1, iblockstate1, false);
            fillWithBlocks(worldIn, structureBB, 1, 1, 4, 2, 3, 4, iblockstate1, iblockstate1, false);
            ...
            int tablePosition = additionalData & 3;
            if (tablePosition > 0) {
    ...
    class MU Well final : public VillagePiece {
    public:
        Well() = delete;

        MU explicit Well(int structureType)
            : VillagePiece(structureType) {}

        bool addComponentParts(World& worldIn, RNG& rng, const BoundingBox& structureBB) override {
            int averageGroundLvl = getAverageGroundLevel(worldIn, structureBB);
            if (averageGroundLvl < 0) { return true; }
            offset(0, averageGroundLvl - maxY + 3, 0);
            ...
            fillWithBlocks(worldIn, structureBB, 1, 0, 1, 4, 12, 4, iblockstate, &lce::blocks::BlocksInit::FLOWING_WATER, false);
            ...
            fillWithBlocks(worldIn, structureBB, 1, 15, 1, 4, 15, 4, iblockstate, iblockstate, false);
