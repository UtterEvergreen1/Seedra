...
namespace build::village {
    MU void func_189927_a(MU const World &p_189927_1_, gen::Village *villageIn, MU BoundingBox p_189927_2_,
    ...
    MU void func_189926_a(MU const World &p_189926_1_, gen::Village *villageIn, MU enumFacing p_189926_2_,
                          MU int p_189926_3_, MU int p_189926_4_, MU int p_189926_5_, MU BoundingBox p_189926_6_) {
        if (!villageIn->isZombieInfested) {
    ...
    bool Church::addComponentParts(
        World &worldIn, MU RNG &rng, BoundingBox &structureBB, StructureComponent &piece) {
        ...
        structureBB.encompassY(piece);

        const lce::blocks::Block *cobblestone = getBiomeSpecificBlockState(
            &lce::blocks::BlocksInit::COBBLESTONE, piece.structureType);

        c_auto cobbleStairsSouth = getBiomeSpecificBlockState(&lce::blocks::BlocksInit::COBBLESTONE_STAIRS,
                                                              piece.structureType);
        const auto cobbleStairsNorth = cobbleStairsSouth->getStateFromMeta(
            lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::NORTH)));
        const auto cobbleStairsWest = cobbleStairsSouth->getStateFromMeta(
            lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::WEST)));
        const auto cobbleStairsEast = cobbleStairsSouth->getStateFromMeta(
            lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::EAST)));
        ...
        piece.setBlockState(worldIn, cobbleStairsNorth, 1, 1, 5, structureBB);
        piece.setBlockState(worldIn, cobbleStairsNorth, 2, 1, 6, structureBB);
        piece.setBlockState(worldIn, cobbleStairsNorth, 3, 1, 5, structureBB);
        piece.setBlockState(worldIn, cobbleStairsWest, 1, 2, 7, structureBB);
        piece.setBlockState(worldIn, cobbleStairsEast, 3, 2, 7, structureBB);
        ...
        const lce::blocks::Block ladderWest = lce::blocks::BlocksInit::LADDER.getStateFromMeta(
            lce::blocks::states::Ladder::withProperty(piece.rotation.apply(piece.mirror, enumFacing::WEST)));

        for (int i = 1; i <= 9; ++i) {
            piece.setBlockState(worldIn, ladderWest, 3, i, 3, structureBB);
        }
        ...
        if (lce::blocks::ids::isReplaceableBlock(piece.getBlockStateFromPos(worldIn, 2, 0, -1, structureBB)->getID()) &&
            !lce::blocks::ids::isReplaceableBlock(
                piece.getBlockStateFromPos(worldIn, 2, -1, -1, structureBB)->getID())) {
            piece.setBlockState(worldIn, cobbleStairsNorth, 2, 0, -1, structureBB);
    ...
    bool Field1::addComponentParts(
        ...
        const lce::blocks::Block *iBlockState = getBiomeSpecificBlockState(
            &lce::blocks::BlocksInit::OAK_WOOD, piece.structureType);
        ...
        piece.fillWithBlocks(worldIn, structureBB, 3, 0, 1, 3, 0, 7, &lce::blocks::BlocksInit::FLOWING_WATER,
                             false);
        piece.fillWithBlocks(worldIn, structureBB, 9, 0, 1, 9, 0, 7, &lce::blocks::BlocksInit::STILL_WATER,
                             &lce::blocks::BlocksInit::FLOWING_WATER, false);
        ...
        for (int j2 = 0; j2 < 9; ++j2) {
            for (int k2 = 0; k2 < 13; ++k2) {
                ...
                piece.replaceAirAndLiquidDownwards(worldIn, &lce::blocks::BlocksInit::DIRT, k2, -1, j2,
                                                   structureBB);
            }
        }
    ...
    bool Field2::addComponentParts(
        ...
        for (int j1 = 0; j1 < 9; ++j1) {
            for (int k1 = 0; k1 < 7; ++k1) {
                ...
                piece.replaceAirAndLiquidDownwards(worldIn, &lce::blocks::BlocksInit::DIRT, k1, -1, j1,
                                                   structureBB);
            }
        }
    ...
    bool Hall::addComponentParts(
        ...
        c_auto woodStairs = getBiomeSpecificBlockState(&lce::blocks::BlocksInit::OAK_WOOD_STAIRS,
                                                       piece.structureType);
        c_auto iBlockState1 = woodStairs->getStateFromMeta(
            lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::NORTH)));
        c_auto iBlockState2 = woodStairs->getStateFromMeta(
            lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::SOUTH)));
        c_auto iBlockState3 = woodStairs->getStateFromMeta(
            lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::WEST)));

        const lce::blocks::Block *iBlockState4 = getBiomeSpecificBlockState(
            &lce::blocks::BlocksInit::OAK_WOOD_PLANK, piece.structureType);
        const lce::blocks::Block *iBlockState5 = getBiomeSpecificBlockState(
            &lce::blocks::BlocksInit::OAK_WOOD, piece.structureType);
        const lce::blocks::Block *iBlockState6 = getBiomeSpecificBlockState(
            &lce::blocks::BlocksInit::OAK_FENCE, piece.structureType);
        ...
        piece.fillWithBlocks(worldIn, structureBB, 5, 0, 1, 7, 0, 3, &lce::blocks::BlocksInit::DOUBLE_STONE_SLAB,
                             false);
        ...
        if (lce::blocks::ids::isReplaceableBlock(
                piece.getBlockStateFromPos(worldIn, 2, 0, -1, structureBB)->getID()) &&
            !lce::blocks::ids::isReplaceableBlock(
                piece.getBlockStateFromPos(worldIn, 2, -1, -1, structureBB)->getID())) {
            piece.setBlockState(worldIn, iBlockState7, 2, 0, -1, structureBB);

            if (piece.getBlockStateFromPos(worldIn, 2, -1, -1, structureBB) == &
                lce::blocks::BlocksInit::GRASS_PATH) {
                piece.setBlockState(worldIn, &lce::blocks::BlocksInit::GRASS, 2, -1, -1, structureBB);
            }
        }
    ...
    bool House1::addComponentParts(
        ...
        const auto wood_stairs = getBiomeSpecificBlockState(&lce::blocks::BlocksInit::OAK_WOOD_STAIRS,
                                                            piece.structureType);
        const lce::blocks::Block iBlockState1 = wood_stairs->getStateFromMeta(
            lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::NORTH)));
        const lce::blocks::Block iBlockState2 = wood_stairs->getStateFromMeta(
            lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::SOUTH)));
        const lce::blocks::Block iBlockState3 = wood_stairs->getStateFromMeta(
            lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::EAST)));
        ...
        const lce::blocks::Block iBlockState5 = getBiomeSpecificBlockState(
                    &lce::blocks::BlocksInit::COBBLESTONE_STAIRS, piece.structureType)
                ->getStateFromMeta(
                    lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::NORTH)));
        const lce::blocks::Block *iBlockState6 = getBiomeSpecificBlockState(
            &lce::blocks::BlocksInit::OAK_FENCE, piece.structureType);
        ...
        if (lce::blocks::ids::isReplaceableBlock(
                piece.getBlockStateFromPos(worldIn, 1, 0, -1, structureBB)->getID()) &&
            !lce::blocks::ids::isReplaceableBlock(
                piece.getBlockStateFromPos(worldIn, 1, -1, -1, structureBB)->getID())) {
            piece.setBlockState(worldIn, iBlockState5, 1, 0, -1, structureBB);

            if (piece.getBlockStateFromPos(worldIn, 1, -1, -1, structureBB) == &
                lce::blocks::BlocksInit::GRASS_PATH) {
    ...
    bool House2::addComponentParts(
        ...
        const lce::blocks::Block *iBlockState = getBiomeSpecificBlockState(
            &lce::blocks::BlocksInit::COBBLESTONE, piece.structureType);
        const lce::blocks::Block iBlockState1 = getBiomeSpecificBlockState(
                    &lce::blocks::BlocksInit::OAK_WOOD_STAIRS, piece.structureType)
                ->getStateFromMeta(
                    lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::NORTH)));
        const lce::blocks::Block iBlockState2 = getBiomeSpecificBlockState(
                    &lce::blocks::BlocksInit::OAK_WOOD_STAIRS, piece.structureType)
                ->getStateFromMeta(
                    lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::WEST)));
        const lce::blocks::Block *iBlockState3 = getBiomeSpecificBlockState(
            &lce::blocks::BlocksInit::OAK_WOOD_PLANK, piece.structureType);
        const lce::blocks::Block iBlockState4 = getBiomeSpecificBlockState(
                    &lce::blocks::BlocksInit::COBBLESTONE_STAIRS, piece.structureType)
                ->getStateFromMeta(
        ...
        if (!hasMadeChest && structureBB.isVecInside(chestPos)) {
            piece.setBlockState(worldIn, lce::blocks::BlocksInit::CHEST, 5, 1, 5, structureBB);
            rng.nextLong();
        ...
        for (int i = 6; i <= 8; ++i) {
            if (lce::blocks::ids::isReplaceableBlock(
                    piece.getBlockStateFromPos(worldIn, i, 0, -1, structureBB)->getID()) &&
                !lce::blocks::ids::isReplaceableBlock(
                    piece.getBlockStateFromPos(worldIn, i, -1, -1, structureBB)->getID())) {
                piece.setBlockState(worldIn, iBlockState4, i, 0, -1, structureBB);

                if (piece.getBlockStateFromPos(worldIn, i, -1, -1, structureBB) == &
                    lce::blocks::BlocksInit::GRASS_PATH) {
    ...
    bool House4Garden::addComponentParts(
        World &worldIn, MU RNG &rng, BoundingBox &structureBB, StructureComponent &piece) {
        c_int averageGroundLvl = getAverageGroundLevel(worldIn, structureBB, piece);
        if (averageGroundLvl < 0) { return true; }
        piece.offset(0, averageGroundLvl - piece.maxY + 6 - 1, 0);
        ...
        if (piece.getBlockStateFromPos(worldIn, 2, 0, -1, structureBB)->getID() != lce::blocks::ids::AIR_ID &&
            piece.getBlockStateFromPos(worldIn, 2, -1, -1, structureBB)->getID() != lce::blocks::ids::AIR_ID) {
            // material air
            piece.setBlockState(worldIn, iBlockState2, 2, 0, -1, structureBB);

            if (piece.getBlockStateFromPos(worldIn, 2, -1, -1, structureBB)->getID() ==
                lce::blocks::ids::GRASS_PATH_ID) {
                piece.setBlockState(worldIn, lce::blocks::BlocksInit::GRASS, 2, -1, -1, structureBB);
            }
        }
        ...
        if (piece.data & 1) /* isRoofAccessible */ {
            ...
            c_auto ladderSouth = lce::blocks::BlocksInit::LADDER.getStateFromMeta(
                lce::blocks::states::Ladder::withProperty(piece.rotation.apply(piece.mirror, enumFacing::SOUTH)));
            piece.setBlockState(worldIn, ladderSouth, 3, 1, 3, structureBB);
            piece.setBlockState(worldIn, ladderSouth, 3, 2, 3, structureBB);
            piece.setBlockState(worldIn, ladderSouth, 3, 3, 3, structureBB);
            piece.setBlockState(worldIn, ladderSouth, 3, 4, 3, structureBB);
        }
    ...
    bool Path::addComponentParts(
            World &worldIn, MU RNG &rng, const BoundingBox &structureBB, const StructureComponent &piece) {
            const lce::blocks::Block *iblockstate = getBiomeSpecificBlockState(
                &lce::blocks::BlocksInit::GRASS_PATH, piece.structureType);
            const lce::blocks::Block *iblockstate1 = getBiomeSpecificBlockState(
                &lce::blocks::BlocksInit::OAK_WOOD_PLANK, piece.structureType);
            const lce::blocks::Block *iblockstate2 = getBiomeSpecificBlockState(
                &lce::blocks::BlocksInit::GRAVEL, piece.structureType);
            const lce::blocks::Block *iblockstate3 = getBiomeSpecificBlockState(
                &lce::blocks::BlocksInit::COBBLESTONE, piece.structureType);
    ...
    bool Torch::addComponentParts(
        ...
        const lce::blocks::Block *oakFence = getBiomeSpecificBlockState(
            &lce::blocks::BlocksInit::OAK_FENCE, piece.structureType);
    ...
    bool WoodHut::addComponentParts(
            World &worldIn, MU RNG &rng, BoundingBox &structureBB, StructureComponent &piece) {
            c_int averageGroundLvl = getAverageGroundLevel(worldIn, structureBB, piece);
            if (averageGroundLvl < 0) { return true; }
            piece.offset(0, averageGroundLvl - piece.maxY + 6 - 1, 0);
            ...
            if (tablePosition > 0) {
                ...
                piece.setBlockState(worldIn, &lce::blocks::BlocksInit::WOODEN_PRESSURE_PLATE, tablePosition, 2, 3,
                                    structureBB);
            }
    ...
    bool Well::addComponentParts(
            ...
            piece.fillWithBlocks(worldIn, structureBB, 1, 0, 1, 4, 12, 4, iblockstate,
                                 &lce::blocks::BlocksInit::FLOWING_WATER, false);
