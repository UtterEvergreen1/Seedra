...
namespace build::stronghold {
    void placeDoor(World &worldIn, RNG &rng, const BoundingBox &structureBB, const StructureComponent &piece,
        ...
        switch (door) {
            ...
            case Door::IRON_DOOR: {
                ...
                const lce::blocks::Block doorBlockLower = lce::blocks::BlocksInit::IRON_DOOR_BLOCK.getStateFromMeta(
                    lce::blocks::states::DoorLower::withProperty(piece.rotation.apply(piece.mirror, enumFacing::EAST)));
                ...
                const lce::blocks::Block buttonBlock1 = lce::blocks::BlocksInit::STONE_BUTTON.getStateFromMeta(
                    lce::blocks::states::Button::withProperty(piece.rotation.apply(piece.mirror, enumFacing::NORTH)));
    ...
    bool ChestCorridor::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
    ...
    bool Corridor::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
                                     const StructureComponent &piece) {
        if (piece.isLiquidInStructureBoundingBox(worldIn, structureBB)) { return false; }

        c_int steps = piece.facing != enumFacing::NORTH && piece.facing != enumFacing::SOUTH
                          ? piece.getXSize()
                          : piece.getZSize();
    ...
    bool Crossing::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
                                     const StructureComponent &piece) {
        if (piece.isLiquidInStructureBoundingBox(worldIn, structureBB)) { return false; }
        ...
        const lce::blocks::Block torchSouth = lce::blocks::BlocksInit::TORCH.getStateFromMeta(
            lce::blocks::states::Torch::withProperty(piece.rotation.apply(piece.mirror, enumFacing::SOUTH)));
        piece.setBlockState(worldIn, torchSouth, 6, 5, 6, structureBB);
        return true;
    }

    bool LeftTurn::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
                                     const StructureComponent &piece) {
        if (piece.isLiquidInStructureBoundingBox(worldIn, structureBB)) { return false; }
    ...
    bool Library::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
                                    const StructureComponent &piece) {
        if (piece.isLiquidInStructureBoundingBox(worldIn, structureBB)) { return false; }
        ...
        piece.fillWithBlocksRandomLightCheck(worldIn, structureBB, rng, 0.07F, 2, 1, 1, 11, 4, 13,
                                             &lce::blocks::BlocksInit::COBWEB, &lce::blocks::BlocksInit::COBWEB, false,
                                             0);
        // int j = 1;
        // int k = 12;
        ...
        for (int l = 1; l <= 13; ++l) {
            if ((l - 1) % 4 == 0) {
                ...
                auto torchEast = torch->getStateFromMeta(lce::blocks::states::Torch::withProperty(piece.rotation.apply(piece.mirror, enumFacing::EAST)));
                piece.setBlockState(worldIn, torchEast, 2, 3, l, structureBB);

                auto torchWest = torch->getStateFromMeta(lce::blocks::states::Torch::withProperty(piece.rotation.apply(piece.mirror, enumFacing::WEST)));
        ...
        if (isLargeRoom) {
            ...
            c_auto torchUp = torch->getStateFromMeta(lce::blocks::states::Torch::withProperty(piece.rotation.apply(piece.mirror, enumFacing::UP)));
    ...
    bool PortalRoom::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
                                       const StructureComponent &piece) {
        ...
        const lce::blocks::Block cobbleStairNorth = lce::blocks::BlocksInit::STONE_BRICK_STAIRS
                .getStateFromMeta(lce::blocks::states::Stairs::withProperty(piece.rotation.apply(piece.mirror, enumFacing::NORTH)));
    ...
    bool Prison::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
                                   const StructureComponent &piece) {
        if (piece.isLiquidInStructureBoundingBox(worldIn, structureBB)) { return false; }
        ...
        const lce::blocks::Block iblockstate = lce::blocks::BlocksInit::IRON_DOOR_BLOCK.getStateFromMeta(
            lce::blocks::states::DoorLower::withProperty(piece.rotation.apply(piece.mirror, enumFacing::WEST)));
    ...
    bool RightTurn::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
                                      const StructureComponent &piece) {
        if (piece.isLiquidInStructureBoundingBox(worldIn, structureBB)) { return false; }
    ...
    bool RoomCrossing::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
                                         const StructureComponent &piece) {
        if (piece.isLiquidInStructureBoundingBox(worldIn, structureBB)) { return false; }
        ...
        switch (roomType) {
            ...
            // .withProperty(BlockTorch.FACING, FACING::WEST)
                piece.setBlockState(worldIn, lce::blocks::BlocksInit::TORCH.getStateFromMeta(
                                        lce::blocks::states::Torch::withProperty(piece.rotation.apply(piece.mirror, enumFacing::WEST))), 4, 3, 5,
                                    structureBB);
            // .withProperty(BlockTorch.FACING, FACING::EAST)
                piece.setBlockState(worldIn, lce::blocks::BlocksInit::TORCH.getStateFromMeta(
                                        lce::blocks::states::Torch::withProperty(piece.rotation.apply(piece.mirror, enumFacing::EAST))), 6, 3, 5,
                                    structureBB);
            // .withProperty(BlockTorch.FACING, FACING::SOUTH)
                piece.setBlockState(worldIn, lce::blocks::BlocksInit::TORCH.getStateFromMeta(
                                        lce::blocks::states::Torch::withProperty(piece.rotation.apply(piece.mirror, enumFacing::SOUTH))), 5, 3, 4,
                                    structureBB);
            // .withProperty(BlockTorch.FACING, FACING::NORTH)
                piece.setBlockState(worldIn, lce::blocks::BlocksInit::TORCH.getStateFromMeta(
                                        lce::blocks::states::Torch::withProperty(piece.rotation.apply(piece.mirror, enumFacing::NORTH))), 5, 3, 6,
                                    structureBB);
    ...
    bool Stairs::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
                                   const StructureComponent &piece) {
        if (piece.isLiquidInStructureBoundingBox(worldIn, structureBB)) { return false; }
    ...
    bool StairsStraight::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
                                           const StructureComponent &piece) {
        if (piece.isLiquidInStructureBoundingBox(worldIn, structureBB)) { return false; }
    ...
    bool Straight::addComponentParts(World &worldIn, RNG &rng, const BoundingBox &structureBB,
                                     const StructureComponent &piece) {
        if (piece.isLiquidInStructureBoundingBox(worldIn, structureBB)) { return false; }
        ...
        const lce::blocks::Block iblockstate = lce::blocks::BlocksInit::TORCH.getStateFromMeta(
            lce::blocks::states::Torch::withProperty(piece.rotation.apply(piece.mirror, enumFacing::EAST)));
        // .withProperty(BlockTorch.FACING, FACING::WEST)
        const lce::blocks::Block iblockstate1 = lce::blocks::BlocksInit::TORCH.getStateFromMeta(
            lce::blocks::states::Torch::withProperty(piece.rotation.apply(piece.mirror, enumFacing::WEST)));
