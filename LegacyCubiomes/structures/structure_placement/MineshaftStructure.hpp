...
namespace Structure {
    ...
    public:
         ...
         */
        ND MU static std::vector<Pos2D> getPositions(int64_t worldSeed, int xLower, int zLower, int xUpper, int zUpper);
         ...
         * @return a vector of chunk positions for all the mineshafts within the radius
         */
        ND MU inline static std::vector<Pos2D> getPositions(int64_t worldSeed, int x, int z, int radius) {
