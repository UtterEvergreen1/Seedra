...
namespace structure_rolls {
    ...
    public:
        ...
        void generateChest(ChunkPrimer* chunk, const BoundingBox &chunkBB, const Piece &piece, RNG& rng, int x, int y, int z);
        static void placeCobWeb(ChunkPrimer* chunk, const BoundingBox &chunkBB, const Piece &piece, RNG& rng, int x, int z);
    };
