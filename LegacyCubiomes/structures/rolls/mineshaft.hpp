...
namespace structure_rolls {
    ...
    public:
        ...
        void generateStructure(generation::Mineshaft* mineshaftGenerator, ChunkPrimer *chunk, RNG& rng, int chunkX, int chunkZ);
        ...
        void generateChest(ChunkPrimer* chunk, const BoundingBox &chunkBoundingBox, const Piece &piece, RNG& rng, int x, int y, int z);
        static void placeCobWeb(ChunkPrimer* chunk, const BoundingBox &chunkBoundingBox, const Piece &piece, RNG& rng, int x, int z);
    };
