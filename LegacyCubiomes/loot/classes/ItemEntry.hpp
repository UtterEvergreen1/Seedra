...
public:
    ...
    ItemEntry(const Items::Item* item, uint8_t weight) : LootItem(item, weight), UniformRoll(1, 1) {}
    ...
    ItemEntry(const Items::Item* item, LootFunction* lootFunction, uint8_t weight, uint8_t min, uint8_t max)
