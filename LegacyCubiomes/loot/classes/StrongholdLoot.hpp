...
namespace loot_tables {
    ...
    public:
        ...
        static uint64_t getLootSeed(const Generator& g, StrongholdGenerator* strongholdGenerator, const BasePiece& piece, int chestChunkX, int chestChunkZ) {
            ...
            if constexpr (checkCaves) {
                ...
                if(!structure_rolls::StrongholdRolls::generateStructure<true>(chunk, strongholdGenerator, &rng, piece, chestChunkX, chestChunkZ)) {
                    delete chunk;
                    return -1;
                }
                delete chunk;
                ...
                structure_rolls::StrongholdRolls::generateStructure<true>(nullptr, strongholdGenerator, &rng, piece, chestChunkX, chestChunkZ);
            }
            return rng;
        }
        ...
        ND static Container getLoot(const Generator& g, StrongholdGenerator* strongholdGenerator, const BasePiece& piece, int chestChunkX, int chestChunkZ) {
