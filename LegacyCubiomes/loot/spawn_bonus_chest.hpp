...
#include "LegacyCubiomes/loot/classes/SetMetadata.hpp"
...
namespace loot {
    ...
    void SpawnBonusChest::setup() {
        ...
        const std::vector<const Items::Item*> LOG1_vec =
        ...
        items8.emplace_back(&Items::OAK_WOOD, new SetMetadata({0, 3}, LOG1_vec),    10, 1, 3);
        items8.emplace_back(&Items::ACACIA_WOOD, new SetMetadata({0, 1}, LOG2_vec), 10, 1, 3);
