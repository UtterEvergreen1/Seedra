...
namespace loot_tables {
    ...
    void Mansion::setup() {
        ...
        items1.emplace_back(&NAME_TAG,                    10);
        items1.emplace_back(&CHAINMAIL_CHESTPLATE,        10);
        items1.emplace_back(&DIAMOND_HOE,                 15);
        items1.emplace_back(&DIAMOND_CHESTPLATE,           5);
        items1.emplace_back(&ENCHANTED_BOOK,              10); // function=enchant_randomly
        lootTables.emplace_back(items1,            1, 3, 117);
