...
#include "../structure_generation/stronghold_generator/StrongholdGenerator.hpp"
namespace structure_rolls {
    ...
    public:
        ...
        static void generateStructure(uint64_t *random, int chestX, int chestY, int chestZ, stronghold_generator::StrongholdGenerator* strongholdGenerator, ChunkPrimer *chunk);
    };

    template<bool isStrongholdChest>
    void StrongholdRolls::generateStructure(uint64_t *random, int chestX, int chestY, int chestZ, stronghold_generator::StrongholdGenerator* strongholdGenerator, ChunkPrimer *chunk) {
        int chunkX = chestX >> 4;
        int chunkZ = chestZ >> 4;
        for (stronghold_generator::Piece &piece: strongholdGenerator->pieces) {
            if (piece.type != stronghold_generator::PieceType::NONE) {
                ...
                if (pieceBoundingBox.intersects(chunkBoundingBox)) {
                    ...
                    switch (piece.type) {
                    case stronghold_generator::PieceType::STRAIGHT:
                        ...
                        *random = (*random * 0x32EB772C5F11 + 0x2D3873C4CD04) & 0xFFFFFFFFFFFF; // 4 rolls
                        break;
                    case stronghold_generator::PieceType::PRISON_HALL:
                        ...
                        *random = (*random * 0x199C3838D031 + 0xD4CF89E2CFCC) & 0xFFFFFFFFFFFF; // 12 rolls
                        break;
                    case stronghold_generator::PieceType::LEFT_TURN:
                    case stronghold_generator::PieceType::RIGHT_TURN:
                        fillWithRandomizedBlocks(chunkBoundingBox, piece, 0, 0, 0, 4, 4, 4, random, chunk);
                        break;
                    case stronghold_generator::PieceType::ROOM_CROSSING:
                        ...
                        break;
                    case stronghold_generator::PieceType::STRAIGHT_STAIRS_DOWN:
                        fillWithRandomizedBlocks(chunkBoundingBox, piece, 0, 0, 0, 4, 10, 7, random, chunk);
                        break;
                    case stronghold_generator::PieceType::STAIRS_DOWN:
                        fillWithRandomizedBlocks(chunkBoundingBox, piece, 0, 0, 0, 4, 10, 4, random, chunk);
                        break;
                    case stronghold_generator::PieceType::FIVE_CROSSING:
                        ...
                        *random = (*random * 0xE3DB7EC1825D + 0xF751DEF08DC7) & 0xFFFFFFFFFFFF; // 109 rolls
                        break;
                    case stronghold_generator::PieceType::CHEST_CORRIDOR:
                        ...
                        break;
                    case stronghold_generator::PieceType::LIBRARY:
                        ...
                        *random = (*random * 0x53E5A095E721 + 0xCACA74409848) & 0xFFFFFFFFFFFF; // 520 rolls
                        ...
                        break;
                    case stronghold_generator::PieceType::PORTAL_ROOM:
                        ...
                        *random = (*random * 0x129FF9FE0B11 + 0x80152440A804) & 0xFFFFFFFFFFFF; // 760 rolls + 12 eye rolls = 772 rolls
                        break;
                    case stronghold_generator::PieceType::FILLER_CORRIDOR:
                    case stronghold_generator::PieceType::NONE:
                        break;
                    }
                }
            }
